...
**Steps:**
1. Download the latest JAR from [Releases](https://github.com/colin1112a/pvp-helper/releases)
...
Output: `build/libs/playerhighlight-<version>.jar`
...
**步骤：**
1. 从 [Releases](https://github.com/colin1112a/pvp-helper/releases) 下载最新 JAR
...
输出：`build/libs/playerhighlight-<version>.jar`
